                  ...
                  <Grid container direction="row" spacing={2}>
                    <Grid item xs={12} sm={6} md={6} lg={6}>
                      <FormControl className={classes.margin}>
                        ...
                        <Autocomplete options={props.clientList}
                          disableClearable
                          ...
                          renderInput={(params) => (
                            ...
                            <TextField
                              {...props.register('clientId')} error={props.errors.clientId ? true : false}
                              {...params}
                              variant="filled"
                              name="clientId"
                            />
                    ...
                    <Grid item xs={12} sm={6} md={6} lg={6}>
                      <FormControl className={classes.margin}>
                        ...
                        <Autocomplete
                          ...
                          onChange={(event, value) => { props.setRequirementsOrgId(value.id);}}
                    ...
                    <Tooltip  title="Delete JD"  placement="bottom" aria-label="delete" >
                         <DeleteIcon   className={classes.toolIconDelete}   onClick={(e) =>{ props.setFile([]) }} />
                    </Tooltip>
