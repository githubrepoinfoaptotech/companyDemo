      ...
      <Dialog onClose={props.handleStatusClose} aria-labelledby="dialog-title" open={props.stausOpen} width='md'
          ...
          <div className={classes.center} >
            <div className={classes.drawerClose}>
              ...
              <Typography variant="subtitle2" className={classes.digColor+" "+classes.digCenter}>  {props.shortList.statusCode === 301 ? "Has the profile been processed for the client?": props.shortList.statusCode === 3081 ? "Can you confirm if the candidate has indeed joined?"  : "Send WhatsApp message"}  </Typography> 
              <div   className={classes.drawerClose} >
                    <CloseIcon
